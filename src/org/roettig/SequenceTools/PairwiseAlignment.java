...
public class PairwiseAlignment
{
	 ...
	 * @throws ChangeVetoException
	 */
	public double align(String xs, String ys, SequenceIdentity id_calc) throws IllegalSymbolException, ChangeVetoException
	{
		Sequence x = SeqTools.makeProteinSequence("1", xs);
		Sequence y = SeqTools.makeProteinSequence("2", ys);
